...
function population = InitializePopulation(populationSize, maxChromosomeLength, minChromosomeLength, numberOfOperators, numberOfVariableRegisters, numberOfConstantRegisters)
    ...
    for i = 1:populationSize
        ...
        chromosomeLength = 4* randi([1,maximumNumberOfInstructions]);
