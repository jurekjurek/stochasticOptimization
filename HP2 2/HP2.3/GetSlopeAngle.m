...
elseif (iDataSet == 2)                            % Validation
 ...
 elseif (iSlope == 2) 
   alpha = 4 + sin(x/35) + cos(sqrt(5)*x/100); 

 elseif (iSlope == 3) 
   alpha = 3 + sin(x/45) + cos(sqrt(4)*x/70); 

 elseif (iSlope == 4) 
   alpha = 9 + sin(x/40) + cos(sqrt(6)*x/45); 
...
elseif (iDataSet == 3)                           % Test
 ...
 elseif (iSlope == 2)
   alpha = 4 + (x/200) + sin(x/40) + cos(sqrt(7)*x/100);

 elseif (iSlope == 3)
   alpha = 4 - (x/900) + sin(x/20) + cos(sqrt(3)*x/100);

 elseif (iSlope == 4)
   alpha = 4 + (x/500) + sin(x/60) + cos(sqrt(6)*x/100);

 elseif (iSlope == 5)
   alpha = 4 + (x/1000) + sin(x/70) + cos(sqrt(2)*x/100); 
 end
end